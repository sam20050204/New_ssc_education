...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="admittedstudent",
            index=models.Index(
                fields=["batch_month", "batch_year", "batch_status"], name="core_admitt_batch_m_91827a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="batchactionlog",
            index=models.Index(
                fields=["batch_month", "batch_year", "action_type"], name="core_batcha_batch_m_e7ea2b_idx"
            ),
        ),
    ]
