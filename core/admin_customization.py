...
class EnquiryAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Personal Information", {"fields": ("name", "mobile", "education")}),
        ("Course Information", {"fields": ("course", "custom_course")}),
        ("Address", {"fields": ("address", "city", "taluka", "district")}),
...
class AdmittedStudentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Address", {"fields": ("address", "city", "tehsil_block", "district", "pin_code")}),
        (
            "Education & Batch",
            {"fields": ("course", "custom_course", "educational_qualification", "batch_month", "batch_year")},
        ),
        ("Financial Information", {"fields": ("total_fees", "paid_fees", "remaining_fees", "fees_percentage_paid")}),
        ("Photo", {"fields": ("photo",)}),
...
class StudentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Personal Information", {"fields": ("name", "phone", "email", "photo")}),
        ("Course Information", {"fields": ("course", "admission_date")}),
        ("Address", {"fields": ("address", "city", "state", "pincode")}),
        ("Guardian Information", {"fields": ("parent_name", "parent_phone")}),
        ("Financial Information", {"fields": ("total_fees", "paid_fees")}),
        ("Additional Information", {"fields": ("qualification", "date_of_birth", "is_active")}),
...
class FeePaymentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Receipt Information", {"fields": ("receipt_no", "student")}),
        ("Payment Details", {"fields": ("amount", "payment_mode", "payment_date", "remarks")}),
        (
            "Fee Snapshot",
            {"fields": ("total_fees_at_payment", "paid_before_this", "remaining_after_this"), "classes": ("collapse",)},
        ),
        ("Metadata", {"fields": ("created_at", "updated_at"), "classes": ("collapse",)}),
    )

    def student_link(self, obj):
        url = reverse("admin:core_admittedstudent_change", args=[obj.student.id])
...
class StudentFinanceDetailAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        (
            "Fees Paid to MKCL",
            {
                "fields": ("fees_paid_to_mkcl_1", "fees_paid_to_mkcl_2", "fees_paid_to_mkcl_3"),
                "description": "Enter the MKCL fees paid in each installment. Default is 0.",
            },
        ),
        (
            "Summary",
            {"fields": ("total_mkcl_fees", "profit"), "description": "Auto-calculated based on the installments above"},
        ),
        ("Metadata", {"fields": ("created_at", "updated_at"), "classes": ("collapse",)}),
    )
